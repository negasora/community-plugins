...
| [Apple Blocks](https://github.com/droe/binja-blocks)|Daniel Roethlisberger|Annotation of Apple libclosure blocks.|2024-12-31|helper|python3|MIT |
...
| [BinAssist](https://github.com/jtang613/BinAssist)|Jason Tang|A plugin that provides LLM helpers to explain code and assist in RE.|2024-12-19|ui, helper|python3|MIT |
| [BinSync](https://github.com/binsync/binsync)|BinSync Team|Adds support for cross-decompiler collab in the BinSync supported decompilers.|2025-02-12|sync|python3|BSD 2-clause |
